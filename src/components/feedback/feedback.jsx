    ...
    return (
        <div className="feedback">
            ...
            <div className="feedback__container">
                <div className="feedback__requestForm">
                    <form
                    ...
                    >
                        <div className="feedback__unit">
                            ...
                            <input
                                className="feedback__inputField"
                                id="name"
                                type="text"
                                name="name"
                    ...
                    <Button
                        ...
                        form="requestForm"
                        type="submit"
                        extraClass="feedback__submitButton"
                    />
                    <p className="feedback__agreementText">
                ...
                <div className="feedback__contacts">
                    ...
                    <div className="feedback__greensightContacts">
                        <p className="feedback__text feedback__text_style_bold">
                            +7 499 391-66-69
                        </p>
                        <p className="feedback__text feedback__textBold">
                            mail@greensight.ru
                        </p>
                    </div>
                    <div className="feedback__greensightAddress">
                        <p className="feedback__text">
